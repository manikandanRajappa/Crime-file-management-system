...
$qry=mysql_query("insert into message(id,user,message) values($id,'admin','$message')");
if($qry)
{
...
window.location.href="admin_send.php";
</script>
<?php
}
}
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>&nbsp;</p>
  <h2 align="center">Send to IG </h2>
  <table width="614" height="194" border="0" align="center" cellpadding="5">
    <tr>
      <th width="119" align="left" scope="row">Message</th>
      <td width="142" align="left"><textarea name="message" cols="60" rows="5"></textarea></td>
    </tr>
    <tr>
 ...
 {
  ?>
  <table width="602" height="55" border="1" align="center">
    <tr>
    ...
    <tr>
      ...
      <td><a href="admin_send.php?act=del&did=<?php echo $r1['id']; ?>">Delete</a></td>
    </tr>
	<?php
	}
	?>
