...
{
$cid=$_REQUEST['cid'];
mysql_query("update complaint set status='2' where id=$cid");
header("location:station_st.php");
}
...
<form id="form1" name="form1" method="post" action="">
  ...
  <?php
  $qry=mysql_query("select * from complaint where station='$uname' && month='$month' && year='$year' && status=1 order by id desc");
  ...
  <table width="505" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td align="right"><a href="station.php?act=ok&cid=<?php echo $row['id']; ?>">Start</a></td>
    </tr>
  </table>
  <?php
  }
