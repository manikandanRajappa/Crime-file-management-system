...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <div class="hd" align="center"><?php include("title.php"); ?></div>
     ...
     <div class="subhead">
	<ul id="menu">
	   <li><a href="home_ri.php">HOME</a></li>
	   <li><a href="logout.php">LOGOUT</a></li>
	</ul>
</div>
     <p>&nbsp;</p>
     <div align="center">
       <h3>Welcome to POLICE
       </h3>
     </div>
     <p>
       <?php
	 $q1=mysql_query("select * from requires where status=1");
  ...
  <table width="1015" border="1" align="center">
    ...
    <tr>
      ...
      <td><a href="home_ri.php?act=ok&cid=<?php echo $r1['id']; ?>&user=<?php echo $r1['uname']; ?>">Send to Collector</a> </td>
