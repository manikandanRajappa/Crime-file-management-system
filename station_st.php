...
{
$cid=$_REQUEST['cid'];
mysql_query("update complaint set status='3' where id=$cid");
header("location:station_ct.php");
}
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>&nbsp;</p>
  <h2 align="center">Complaint Process</h2>
  <p align="center">
    <select name="month">
      <?php
  ...
  <?php
  $qry=mysql_query("select * from complaint where station='$uname' && month='$month' && year='$year' && status=2 order by id desc");
  ...
  <table width="505" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td align="right"><a href="station_st.php?act=ok&cid=<?php echo $row['id']; ?>">Complete</a></td>
    </tr>
  </table>
  <?php
  }
