...
<form id="form1" name="form1" method="post" action="">
  ...
  <?php
  $qry=mysql_query("select * from complaint where month=$month && year=$year && status=0 order by id desc");
  ...
  <table width="505" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td align="right"><!--<a href="allocate.php?cid=<?php //echo $row['id']; ?>">Allocate</a>--></td>
    </tr>
  </table>
  <?php
  }
